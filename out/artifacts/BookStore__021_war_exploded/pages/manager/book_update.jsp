...
<div class="login_banner">
    <div class="register_form">
        <form action="<%=request.getContextPath()%>/book?action=updateBook" method="post">
            <input type="hidden" name="id" value="${book.id}"/>
            <div class="form-item">
                <div>
                    <label>名称:</label>
                    <input type="text" name="title" placeholder="请输入名称" value="${book.title}"/>
                </div>
            ...
            <div class="form-item">
                <div>
                    <label>价格:</label>
                    <input type="number" name="price" placeholder="请输入价格" value="${book.price}"/>
                </div>
            ...
            <div class="form-item">
                <div>
                    <label>作者:</label>
                    <input type="text" name="author" placeholder="请输入作者" value="${book.author}"/>
                </div>
            ...
            <div class="form-item">
                <div>
                    <label>销量:</label>
                    <input type="number" name="stock" placeholder="请输入销量" value="${book.stock}"/>
                </div>
            ...
            <div class="form-item">
                <div>
                    <label>库存:</label>
                    <input type="number" name="sales" placeholder="请输入库存" value="${book.sales}"/>
                </div>
