        ...
        <div class="w">
            ...
            <div class="topbar-right">
                ...
                <c:if test="${empty sessionScope.user}">
                    ...
                    <a
                            href="<%=request.getContextPath()%>/pages/cart/cart.html"
            ...
            <div class="list">
                ...
                <div class="list-content">
                    ...
                    <div href="" class="list-item">
                        <img src="<%=request.getContextPath()%>/static/uploads/huranqiri.jpg" alt="">
                        <p>书名:活着</p>
                        <p>作者:余华</p>
                        <p>价格:￥66.6</p>
                        <p>销量:230</p>
                    ...
                    <div href="" class="list-item">
                        <img src="<%=request.getContextPath()%>/static/uploads/Javabianchengsixiang.jpg" alt="">
                        <p>书名:活着</p>
                        <p>作者:余华</p>
                        <p>价格:￥66.6</p>
                        <p>销量:230</p>
                    ...
                    <div href="" class="list-item">
                        <img src="<%=request.getContextPath()%>/static/uploads/jiaofu.jpg" alt="">
                        <p>书名:活着</p>
                        <p>作者:余华</p>
                        <p>价格:￥66.6</p>
                        <p>销量:230</p>
                    ...
                    <div href="" class="list-item">
                        <img src="<%=request.getContextPath()%>/static/uploads/jieyouzahuodian.jpg" alt="">
                        <p>书名:活着</p>
                        <p>作者:余华</p>
                        <p>价格:￥66.6</p>
                        <p>销量:230</p>
                    ...
                    <div href="" class="list-item">
                        <img src="<%=request.getContextPath()%>/static/uploads/kanjian.jpg" alt="">
                        <p>书名:活着</p>
                        <p>作者:余华</p>
                        <p>价格:￥66.6</p>
                        <p>销量:230</p>
                    ...
                    <div href="" class="list-item">
                        <img src="<%=request.getContextPath()%>/static/uploads/pinang.jpg" alt="">
                        <p>书名:活着</p>
                        <p>作者:余华</p>
                        <p>价格:￥66.6</p>
                        <p>销量:230</p>
                    ...
                    <div href="" class="list-item">
                        <img src="<%=request.getContextPath()%>/static/uploads/pingfandeshijie.jpg" alt="">
                        <p>书名:活着</p>
                        <p>作者:余华</p>
                        <p>价格:￥66.6</p>
                        <p>销量:230</p>
                    ...
                    <div href="" class="list-item">
                        <img src="<%=request.getContextPath()%>/static/uploads/qiadaohaochudexingfu.jpg" alt="">
                        <p>书名:活着</p>
                        <p>作者:余华</p>
                        <p>价格:￥66.6</p>
                        <p>销量:230</p>
                    ...
                    <div href="" class="list-item">
                        <img src="<%=request.getContextPath()%>/static/uploads/renyueshenhua.jpg" alt="">
                        <p>书名:活着</p>
                        <p>作者:余华</p>
                        <p>价格:￥66.6</p>
                        <p>销量:230</p>
